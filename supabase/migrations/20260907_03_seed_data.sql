-- ==============================================================================
-- BTechPath AI OS — Migration 03: Rich Engineering Seed Data
-- Target: PostgreSQL 14+ / Supabase
-- Description: Standard engineering branches, subjects, curated careers,
--              internships, official exam syllabus taxonomy, and active recall decks.
--              Fully idempotent using ON CONFLICT DO NOTHING.
-- ==============================================================================
